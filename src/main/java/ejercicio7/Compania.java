/*Ejercicio 7
Una compañía tiene cuatro vendedores que venden cinco productos distintos. Al finalizar la jornada
laboral, cada vendedor pasa una nota por cada tipo de producto vendido. Cada nota contiene lo
siguiente:
...
información para las ventas del último mes y que resuma las ventas totales por vendedor, y por
producto. Todos los totales deben guardarse en el vector bidimensional ventas.
...
Calcule el total de cada columna para sacar las ventas totales de cada vendedor durante el último
...
public class Compania {
    ...
    private final static int NUMERO_PRODUCTO[] = {72, 84, 96, 108, 120};
    private final static int NUMERO_VENDEDOR[] = {8, 16, 24, 32};
    private float suTotalVendido;
